...
namespace PHDS.DBUtility
{
    ...
    public sealed class SqlHelper
    {
        ...
        /// <summary> 
        /// 执行数据集更新到数据库,指定获取DataSet时的connectionString与commandText. 
        /// </summary> 
        /// <remarks> 
        /// 示例:  
        ///  UpdateDataset(conn, insertCommand, deleteCommand, updateCommand, dataSet, "Order"); 
        /// </remarks> 
        /// <param name="dataSet">要更新到数据库的DataSet</param> 
        /// <param name="tableIndex">要更新到数据库的DataTable</param> 
        /// <returns>返回影响的行数</returns>
        public static int UpdateDataset(string connectionString, string commandText, DataSet dataSet, int tableIndex)
        {
            // 创建SqlDataAdapter,当操作完成后释放. 
